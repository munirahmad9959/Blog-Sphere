...
const page = () => {
    ...
    const slides = [
        {
            image: 'https://images.unsplash.com/photo-1713472728570-5a6ef3947de1?q=80&w=1480&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
            title: "Is Artificial Intelligence Humanity's Greatest Ally or Its Biggest Threat?",
            author: "Dr. Emily Carter",
            jobTitle: "AI Ethicist and Professor at MIT",
            color: 'bg-[#800080] bg-opacity-50'
        },
        {
        ...
        },
        {
            ...
            jobTitle: "Clinical Pshycologist and Researcher",
            color: "bg-[#FFCC99]"
        }
    ];
    ...
    return (
        <>
            ...
            <div clasName="Bannercontainer w-full h-full">
                <BannerMembership />
            </div>
